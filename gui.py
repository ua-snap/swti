...
about = wrap_in_section(
    [
        ddsih.DangerouslySetInnerHTML(
            f"""
<h1 class="title is-3">Today&rsquo;s Alaska temperatures compared to daily normal temperatures, 1981&ndash;2010</h1>
...
daily_index = wrap_in_section(
    [
        ...
        ddsih.DangerouslySetInnerHTML(
            """
<p class="content is-size-5">Bars show what percent warmer/colder the day was compared to the average temperature for that day between 1981&ndash;2010.  For example, a day with +2 was warmer than 20&#37; of all days between 1981&ndash;2010.</p>
    """
        ),
...
<p>Original version of this visualization by Brian Brettschneider.</p>
            """
        )
    ],
    div_classes="content is-size-5",
