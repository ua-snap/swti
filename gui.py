...
daily_index = wrap_in_section(
    [
        ...
        ddsih.DangerouslySetInnerHTML(
            """
<p class="content is-size-5">Bars show what percent warmer/colder the day was compared to the average temperature for that day between 1981&ndash;2010.  For example, a day with +24&#37; was warmer than 24&#37; of all days between 1981&ndash;2010.</p>
    """
        ),
...
data = dcc.Markdown(
    """
Original version of this visualization by Brian Brettschneider.
    """,
