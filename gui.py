...
temperature anomalies.</li>
    <li>The gray dashed lines at three degrees above and below the “normal” line represent typical daily temperature 
fluctuation. Daily index values within these lines are unexceptional, while values above or below these lines 
